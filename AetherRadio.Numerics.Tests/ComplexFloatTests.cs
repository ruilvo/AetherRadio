...
[TestFixture]
public class ComplexFloatTests
{
    [Test]
    public void TestMagnitude()
    {
        var c = new ComplexFloat(3, 4);
    ...
    {
        var c = ComplexFloat.FromPolar(5, MathF.PI / 3);
        Assert.Multiple(() =>
        {
    ...
    {
        var c1 = new ComplexFloat(3, 4);
        var c2 = new ComplexFloat(1, 2);
        var sum = c1 + c2;
        Assert.Multiple(() =>
        {
